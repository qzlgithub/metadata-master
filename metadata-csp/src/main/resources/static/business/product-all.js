        ...
        function(res) {
            ...
            for(var d in list) {
                ...
                if(typeof list[d].status === 'undefined') {
                    ...
                    htmlStr += '<p class="tc mb15 mt10"><a href="http://wpa.qq.com/msgrd?v=3&amp;uin=3415212827&amp;site=qq&amp;menu=yes"><i class="icon kefu mr5"></i>开通</a> ｜ <a href="/product/introduce.html?id=' + list[d].productId + '">查看详情</a></p>';
                }
                else {
                    ...
                    htmlStr += '<p class="tc mb15 mt10"><a href="http://wpa.qq.com/msgrd?v=3&amp;uin=3415212827&amp;site=qq&amp;menu=yes"><i class="icon kefu mr5"></i>续约</a> ｜ <a href="/product/detail.html?id=' + list[d].productId + '">查看服务</a>'
                }
                htmlStr += '</li>';
            }
