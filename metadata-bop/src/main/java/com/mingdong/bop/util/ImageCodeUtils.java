...
public class ImageCodeUtils
{
    ...
    private static Font getFont()
    {
        ...
        return new Font("Algerian", Font.ITALIC, 18);
    }
     ...
     * 生成随机图片
     */
    public static String getRandcode(String randomString) throws IOException
    {
        ...
        InputStream in = new ByteArrayInputStream(tmp.toByteArray());
    ...
    {
        System.out.println(getRandcode("2132"));
    }
}
