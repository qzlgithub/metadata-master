...
public class ExcelUtil
{
            ...
            int colWidth, OutputStream out)
    {
        ...
        si.setAuthor("明动科技");  // 填加xls文件作者信息
        si.setApplicationName("导出程序"); // 填加xls文件创建程序信息
        si.setLastAuthor("明动科技"); // 填加xls文件最后保存者信息
        si.setComments("明动科技"); // 填加xls文件作者信息
        ...
        {
            if(rowIndex == 1000 || rowIndex == 0)//每页显示1000条
            {
                if(rowIndex != 0)
                {
            ...
            int colWidth, OutputStream out)
    {
        ...
        cellStyle.setFillPattern(HSSFCellStyle.SOLID_FOREGROUND); // 表格样式
            ...
            HttpServletResponse response)
    {
        try
        {
            ...
            response.setContentType(
                    "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;charset=utf-8");//导出xlsx格式
            //response.setContentType("application/vnd.ms-excel");//导出xls格式
